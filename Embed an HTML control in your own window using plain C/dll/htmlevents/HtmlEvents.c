...
#endif
#include <windows.h>
#include "D:\\Desktop\\Embed an HTML control in your own window using plain C\\dll\\cwebpage.h"
#include <tchar.h>
...
static HINSTANCE open_webdll(void)
{
	...
	if ((CWebDll = (HINSTANCE)LoadLibrary(_T("D:\\Desktop\\Embed an HTML control in your own window using plain C\\dll\\Debug\\cwebpage.dll"))))
	{
